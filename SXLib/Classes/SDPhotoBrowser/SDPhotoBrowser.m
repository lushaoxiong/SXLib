...
- (void)saveImage
{
    ...
    YYAnimatedImageView *currentImageView = _scrollView.subviews[index];
...
- (void)photoClick:(UITapGestureRecognizer *)recognizer
{
    ...
    YYAnimatedImageView *tempView = [[YYAnimatedImageView alloc] init];
...
- (void)layoutSubviews
{
    ...
    _indexLabel.center = CGPointMake(self.bounds.size.width * 0.5, 40);
