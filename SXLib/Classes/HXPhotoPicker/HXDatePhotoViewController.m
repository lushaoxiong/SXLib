...
{
    UIButton *returnBtn = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 40, 20)];
    [returnBtn setTitle:@"取消" forState:UIControlStateNormal];
    
    [returnBtn setTitleColor:[UIColor colorWithRed:0/255.0 green:123/255.0 blue:255/255.0 alpha:1.0] forState:UIControlStateNormal];
    [returnBtn addTarget:self action:@selector(didCancelClick) forControlEvents:UIControlEventTouchUpInside];
...
- (void)datePhotoViewCell:(HXDatePhotoViewCell *)cell didSelectBtn:(UIButton *)selectBtn {
    [self.manager maximumOfJudgment:cell.model callback:^(NSString *str) {
