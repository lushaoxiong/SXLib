...
#define MAXSTRINGLENGTH 2000    //限定输入长度
...
- (void)textViewDidEndEditing:(UITextView *)textView{
    ...
    if ([self.delegate respondsToSelector:@selector(chatToolBarTextViewDidEndEditing:)])
    {
        [self.delegate chatToolBarTextViewDidEndEditing:self.textView];
    }
}
