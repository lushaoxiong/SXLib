...
@interface LYSHistogramChart ()

@end
@implementation LYSHistogramChart
{
    CGSize _size;
    NSArray *_rowData;
    CGFloat space_value;
...
-(void)setColumnIndex:(NSInteger)index Withcolor:(UIColor *)color{
    
    [chartLayerAry enumerateObjectsUsingBlock:^(id  _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        LYAnimationLayer *layer =obj;
        if(idx ==index){
